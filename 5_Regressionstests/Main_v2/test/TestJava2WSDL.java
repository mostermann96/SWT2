...
*/
     ...
     */
    @Test
    public void testCorrectOutputFilesHelp() throws FileNotFoundException {
        Java2WSDLRunner java2WSDLRunner=new Java2WSDLRunner();
        ...
        java2WSDLRunner.runJava2WSDL(forOutput,"", Collections.emptyList());
        ...
        //assertTrue(new File("test_output/WidgetPrice_impl.wsdl").exists());
